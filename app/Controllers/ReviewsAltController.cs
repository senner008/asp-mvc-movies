...
{
    public class ReviewsAltController : Controller
    {
        private readonly MvcMovieContext _context;

        public ReviewsAltController(MvcMovieContext context)
        {
            _context = context;
        }

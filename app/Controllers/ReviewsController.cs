...
namespace asp_mvc.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieID,Article")] Review review)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize (Roles = "Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MovieID,Article")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
            ...
            if (await TryUpdateModelAsync<Review>(reviewToUpdate,
                "",
                c => c.MovieID, c => c.Movie, c => c.Article))
            {
                try
                {
